...
public class ViagemCustoAdicionalDao extends BaseDao {
    ...
    private String[] colunas = {
            ViagemCustoAdicionalModel.COLUNA_ID,
            ViagemCustoAdicionalModel.COLUNA_VIAGEM_ID,
            ViagemCustoAdicionalModel.COLUNA_DESCRICAO,
            ViagemCustoAdicionalModel.COLUNA_CUSTO
    };
    ...
    public long DeletarPorViagemId(long viagemId) {
        ...
        try {
            ...
            rowId = db.delete
                    (
                            ViagemCustoAdicionalModel.TABELA_NOME,
                            ViagemCustoAdicionalModel.COLUNA_VIAGEM_ID + " = ?",
